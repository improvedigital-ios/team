...
Этот список литературы на 26.12.2018 полностью повторяет аналогичный список из rambler ios team repo. По мере надобности, будем вносить изменения. В Q1 2019 всей команде нужно будет прочесть литературу из разделов:
