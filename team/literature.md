...
Этот список литературы на 26.12.2018 полностью повторяем аналогичный список из rambler ios team repo. По мере надобности, будем вносить изменения. Но в Q1 2019 всей команде нужно будет прочесть литературу из разделов:
- [Computer science 101](#computer-science-101)
- [ООП](#ООП)
- [Принципы проектирования](#Принципы-проектирования)
- [Тестирование](#Тестирование)

Это тот необходимый уровень фундаментальный знаний, который нам нужно иметь.
